...
Enum.value(MinimalGrammar, "INNER_TYPE", (GrammarSymbol.INNER_TYPE, [GrammarSymbol.TYPE, GrammarSymbol.Base.COMMA, GrammarSymbol.INNER_TYPE]))
Enum.value(MinimalGrammar, "INNER_TYPE_END", (GrammarSymbol.INNER_TYPE, [GrammarSymbol.TYPE]))
